    ...
    <footer className="bg-dark text-gray-300">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid gap-8 md:grid-cols-4">
          <div>
            <h3 className="text-lg font-bold text-white mb-3">Axkan Travel</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>Álvaro Obregón 2, Sta Lucía</li>
              <li>29250 San Cristóbal de las Casas, Chis.</li>
              <li>
                <a href="tel:+529676316101" className="hover:text-secondary transition-colors">
                  +52 967 631 6101
                </a>
              </li>
              <li>
                <a href="https://wa.me/5219671335224" className="hover:text-secondary transition-colors">
                  WhatsApp: 967 133 5224
                </a>
              </li>
              <li>
                <a href="mailto:ventas@disfrutachiapas.com" className="hover:text-secondary transition-colors">
